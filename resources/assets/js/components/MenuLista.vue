                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="articulo in listaArticulosConImagenSrc" :key="articulo.id">
                                    ...
                                    <td>
                                        <span>{{ articulo.tipoMenu === 1 ? 'Mañana' : articulo.tipoMenu === 2 ? 'Noche' : '' }}</span>
                                    </td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div  class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="tipo-menu"><strong>Tipo de Menú(*)</strong></label>
                                    <select v-model="tipo_menu" class="form-control" :class="{ 'border-red': tipoMenuVacio }"
                                        @input="tipoMenuVacio = false">
                                        <option value="" disabled>Seleccione un tipo</option>
                                        <option value="1">Mañanas</option>
                                        <option value="2">Noches</option>
                                    </select>
                                </div>
                            </div>
...
export default {
    ...
    methods: {
        ...
        abrirDialogMenu() {
            ...
            this.nuevoMenuDialog = true;
        },

        ocultarMenuDialog() {
            this.nuevoMenuDialog = false;
            this.submitted = false;
        },
        ...
        listarLinea(page, buscar, criterio) {
            let me = this;
            var url = '/categoriamenu?page=' + page + '&buscar=' + buscar + '&criterio=' + criterio;
            axios.get(url).then(function (response) {
                var respuesta = response.data;
        ...
        //---------hasta aqui----------------
        cargarPdf() {
            window.open('/menu/listarPdf', '_blank');
        },
        ...
        registrarArticulo() {
            ...
            this.tipoMenuVacio = !this.tipo_menu;

            if (this.validarArticulo() || this.tipoMenuVacio) {
                return;
            }
            ...
            formData.append('tipo_menu', this.tipo_menu);
        ...
        registrarLinea() {
            ...
            //}
            let me = this;
            axios.post('/categoriamenu/registrar', {
                            ...
                            case 'actualizar':
                                {
                                    ...
                                    this.tipo_menu = data['tipoMenu'];
                                    console.log("EL TIPO DE MENU ES: ", this.tipo_menu);
