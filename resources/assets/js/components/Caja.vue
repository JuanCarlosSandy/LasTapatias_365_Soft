<template>
    <main class="main">
        ...
        >
            ...
            <!--<Column field="tarifaqrdelivery" header="QR Tarfia Delivery Banco"></Column>-->
    ...
    <Dialog
        ...
        <template #header>
            <div class="sidebar-header">
                ...
                <h4 class="sidebar-title">ABRIR NUEVA CAJA</h4>
            </div>
        </template>
        ...
        <div class="p-inputgroup">
            ...
            <span class="p-float-label">
                <InputNumber class="p-inputnumber-sm" v-model="saldoInicial" mode="currency" currency="BOB" locale="es-BO"/>
                <label for="precio">SALDO INICIAL:</label>
            </span>
        </div>
...
methods : {
    ...
    cerrarCaja(id){
        console.log("plata: ", this.totalEfectito);
    ...
    generarReportePDF() {
        ...
        const datosCajaArray = [
            ...
            ["Saldo Caja", datosCaja.saldoCaja, "Saldo Faltante", datosCaja.saldoFaltante, "Banco Delivery", datosCaja.tarifaqrdelivery]
        ];
